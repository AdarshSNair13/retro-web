          ...
          {[
            {
              ...
              link: "https://xite-live-assignment-theta.vercel.app/",
            },
            { imgSrc: "/images/p3.png", link: "https://www.higbec.com/" },
            {
              imgSrc: "/images/p1.png",
              link: "https://www.arcadiahomes.co.in/",
            },
          ].map((item, index) => (
            <article
              key={index}
              className="filter drop-shadow-md hover:bg-customGreen items-center gap-5 rounded-2xl border-4 border-black bg-white p-8 transition-all hover:scale-105"
            >
              <a
              ...
              >
                <div className="flex flex-col gap-3 hover:no-underline">
                  <img
                    className="filter drop-shadow-md w-full rounded-2xl border border-black"
                    src={item.imgSrc}
                    alt=""
                  />
                  <div></div>
